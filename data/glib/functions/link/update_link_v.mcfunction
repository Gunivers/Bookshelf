...
scoreboard objectives add glib.link.rv dummy [{"text":"GLib ","color":"gold"},{"text":"Link Relative V","color":"dark_gray"}]
...
execute at @e[tag=glib.id.match] run function glib:orientation/get_v/accuracy/10-3
scoreboard players operation @s glib.link.rv -= @s glib.oriV
