#Name: gesture
#Path: glib:system/gesture/gesture
...
execute as @e[scores={gesture=1},tag=gesture] run function glib:system/gesture/speech
# execute as @e[scores={gesture=2},tag=gesture] run function glib:system/gesture/<name>
