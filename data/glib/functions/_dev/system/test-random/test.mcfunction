...
execute as @e[type=area_effect_cloud] run function glib:math/random
...
execute as @e[type=area_effect_cloud] at @s unless block ~ ~ ~ air run function glib:test-loop
