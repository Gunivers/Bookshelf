...
execute at @e[tag=Glib_Pathfind_Source] as @e[tag=Glib_Pathfind_Rewind_Head,limit=1,sort=nearest,distance=0.1..] at @s run function glib:entity/move/child/pathfind/loop_get_path