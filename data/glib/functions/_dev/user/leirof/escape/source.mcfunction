...
execute at @s unless entity @e[tag=Glib_Pathfind_Stop] run function glib:entity/move/child/pathfind/get_possible_moves
execute at @s unless entity @s[tag=Glib_Pathfind_Stop] run function glib:entity/move/child/pathfind/loop_search
