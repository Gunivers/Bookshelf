...
# PATH: glib:memory/save_in_memory
...
#INIT:
function glib_child:core/memory/init
...
#Rec
execute if entity @s[tag=Valid] run function glib_child:core/memory/save_rec
...
execute if entity @s[tag=Valid] unless data entity @s ArmorItems[0].tag.Memory[0] run scoreboard players set @s glib.var0 1
...
execute if entity @s[tag=Valid] if score @s glib.var0 matches 1 run say a
execute if entity @s[tag=Valid] if score @s glib.var0 matches 1 run data modify entity @s ArmorItems[0].tag.Memory prepend value {}
execute if entity @s[tag=Valid] if score @s glib.var0 matches 1 run data modify entity @s ArmorItems[0].tag.Memory[0].glib.id set from entity @s ArmorItems[0].tag.Buffer1
execute if entity @s[tag=Valid] if score @s glib.var0 matches 1 run data modify entity @s ArmorItems[0].tag.Memory[0].Value set from entity @s ArmorItems[0].tag.Buffer2
tag @s remove Valid