...
#tellraw @a[tag=Debug] ["",{"text":"INPUT -> ","color":"gray"},{"text":"New Relative Phi: ","color":"red"},{"score":{"name":"@s","objective":"glib.var1"}},{"text":".   Old Relative Phi: ","color":"red"},{"score":{"name":"@s","objective":"glib.link.r.h"}}]
### END DEBUG

scoreboard players operation @s glib.var1 -= @s glib.link.r.h

scoreboard players operation @s glib.var0 += @s glib.var1

function glib:entity/orientation/zzz_accuracy/10-3/set_v
