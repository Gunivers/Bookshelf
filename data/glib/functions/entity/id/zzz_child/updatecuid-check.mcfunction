...
execute as @e[tag=glib.id.chain.hasToMove,limit=1] run function glib:entity/id/zzz_child/updatecuid-plug
...
execute as @e[tag=glib.id.chain.stacked] run function glib:entity/id/zzz_child/updatecuid-unstack
...
execute as @e[tag=glib.id.chain.anotherLoop,limit=1] run function glib:entity/id/zzz_child/updatecuid-check
