...
execute at @s run function glib:entity/move/zzz_child/by_local_vector/apply

scoreboard players remove @s glib.var3 1

tag @s remove Move-Loop2
tag @s[scores={glib.var3=1..}] add Move-Loop2
execute as @s[tag=Move-Loop2] at @s run function glib:entity/move/zzz_child/by_local_vector/loop2
