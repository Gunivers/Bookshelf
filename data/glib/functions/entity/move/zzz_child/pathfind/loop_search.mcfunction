execute unless entity @e[tag=Glib_Pathfind_Stop] run function glib:entity/move/zzz_config/pathfind/possible_moves/main
...
# Loop
execute as @e[tag=Glib_Pathfind_Target,tag=!Glib_Pathfind_Stop] at @s as @e[tag=Glib_Pathfind_Move,tag=!Glib_Pathfind_Blocked,limit=1,sort=nearest] at @s run function glib:entity/move/zzz_child/pathfind/loop_search
