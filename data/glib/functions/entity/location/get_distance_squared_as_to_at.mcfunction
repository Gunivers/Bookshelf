...
execute store result score @s Var3 run data get entity @s Pos[2] 1

summon area_effect_cloud ~ ~ ~ {Tags:["Glib","Glib_Get_Distance"]}

execute store result score @s Var4 as @e[tag=Glib_Get_Distance] run data get entity @s Pos[0] 1
execute store result score @s Var5 as @e[tag=Glib_Get_Distance] run data get entity @s Pos[1] 1
execute store result score @s Var6 as @e[tag=Glib_Get_Distance] run data get entity @s Pos[2] 1
