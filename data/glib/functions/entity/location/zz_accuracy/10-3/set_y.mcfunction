...
# Original path: glib:entity/location/zzz_accuracy/10-3/set_y
...
execute if entity @s[type=minecraft:player] as @e[tag=SetLocation,limit=1] run function glib:entity/location/zzz_accuracy/10-3/zzz_child/set_y_player
