...
# Original path: glib:entity/location/accuracy/10-3/set_y
...
execute if entity @s[type=!minecraft:player] store result entity @s Pos[1] double 0.001 run scoreboard players add @s glib.var 0
tag @s remove tp
