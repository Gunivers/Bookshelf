...
execute store result score @s glib.var run data get entity @s Pos[0] 10
execute store result score @s glib.var2 run data get entity @s Pos[1] 10
execute store result score @s glib.var3 run data get entity @s Pos[2] 10

summon area_effect_cloud ~ ~ ~ {Tags:["Glib","Glib_Get_Distance"]}

execute store result score @s glib.var4 as @e[tag=Glib_Get_Distance] run data get entity @s Pos[0] 10
execute store result score @s glib.var5 as @e[tag=Glib_Get_Distance] run data get entity @s Pos[1] 10
execute store result score @s glib.var5 as @e[tag=Glib_Get_Distance] run data get entity @s Pos[2] 10
