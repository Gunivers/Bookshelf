...
execute if entity @e[tag=glib.debug.math.getNextPow2] run function gutils:debug/global/message/info/entity_info
...
execute if entity @a[tag=glib.debug.math.getNextPow2] run function gutils:debug/global/message/info/end_debug
# End Debug

# Start Error
execute if score @s glib.var0 matches ..-1 run tellraw @a[tag=glib.debug] [{"text":"ERROR | glib:math/get_next_pow2","color":"red"}]
execute if score @s glib.var0 matches ..-1 run function gutils:debug/global/message/error/entity_info
...
execute if score @s glib.var0 matches 1073741825.. run function gutils:debug/global/message/error/entity_info
