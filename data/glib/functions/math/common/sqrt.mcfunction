...
execute if entity @e[tag=glib.debug.math.sqrt] run function gutils:debug/global/message/info/entity_info
...
execute if entity @a[tag=glib.debug.math.sqrt] run function gutils:debug/global/message/info/end_debug
# End Debug
# Start Error
