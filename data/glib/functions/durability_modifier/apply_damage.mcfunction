...
execute unless entity @s[nbt={SelectedItem:{tag:{}}}] run function glib_child:core/durability_modifier/fix_missing_tag
...
execute at @s run function glib_child:core/durability_modifier/fix_break
