# NAME: Loop Schedule
# PATH: glib_child:utils/schedule/loop_schedule
...
function glib:utils/cache/select_command_block
...
execute at @e[tag=Glib_Cache_Head,tag=isEqual] run data modify block ~ ~1 ~ Command set value "execute as @e[tag=Glib_Cache_Head] at @s run function glib_child:core/utils/schedule/execute_commands"
