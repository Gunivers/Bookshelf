...
# PATH: glib_child:utils/schedule/schedule_command_rec
...
execute unless entity @s[tag=isLower] run function glib_child:core/utils/schedule/schedule_command_rec
