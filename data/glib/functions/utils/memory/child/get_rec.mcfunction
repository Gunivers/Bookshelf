...
# PATH: glib_child:utils/memory/get_rec
...
execute if score @s glib.var0 matches 1 if data entity @s ArmorItems[0].tag.Buffer2[0] run function glib_child:core/utils/memory/get_rec