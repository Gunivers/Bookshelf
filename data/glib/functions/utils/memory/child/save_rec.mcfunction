...
# PATH: glib_child:utils/memory/save_rec
...
execute if score @s glib.var0 matches 1 if data entity @s ArmorItems[0].tag.Memory[0] run function glib_child:core/utils/memory/save_rec
