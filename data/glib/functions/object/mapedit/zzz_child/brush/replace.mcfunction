...
execute at @s run function glib:object/block/convert/block_to_id
...
execute if score @s ActualBlockID = @s glib.original.id run function glib:object/block/convert/id_to_block