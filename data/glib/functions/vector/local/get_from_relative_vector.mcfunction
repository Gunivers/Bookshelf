...
# Original path: glib:local-vector/get_from_relative_vector
...
### DEBUG
execute if entity @a[tag=glib.debug.entity.local_vector.get_from_relative_vector] run function glib:debug/local_vectors/convert_from_vectors/1
### END DEBUG
...
### DEBUG
execute if entity @a[tag=glib.debug.entity.local_vector.get_from_relative_vector] run function glib:debug/local_vectors/convert_from_vectors/2
### END DEBUG
...
### DEBUG
execute if entity @a[tag=glib.debug.entity.local_vector.get_from_relative_vector] run function glib:debug/local_vectors/convert_from_vectors/3
### END DEBUG
