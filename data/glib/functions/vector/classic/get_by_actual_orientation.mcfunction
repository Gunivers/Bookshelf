...
execute if entity @a[tag=glib.debug.entity.vector.get_by_actual_orientation] run function gutils:debug/global/message/info/entity_info
execute if entity @a[tag=glib.debug.entity.vector.get_by_actual_orientation] run function gutils:debug/vector/classic/utils/display_vector
execute if entity @a[tag=glib.debug.entity.vector.get_by_actual_orientation] run function gutils:debug/global/message/info/end_debug
# End Debug
