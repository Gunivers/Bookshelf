...
scoreboard players operation @s Res1 %= 100 Constant
...
execute if entity @s[nbt={SelectedItem:{tag:{Enchantments:[{lvl:1s,id:"minecraft:unbreaking"}]}}}] if score @s Res1 matches ..50 run scoreboard players add @s Var5 1
execute if entity @s[nbt={SelectedItem:{tag:{Enchantments:[{lvl:2s,id:"minecraft:unbreaking"}]}}}] if score @s Res1 matches ..33 run scoreboard players add @s Var5 1
execute if entity @s[nbt={SelectedItem:{tag:{Enchantments:[{lvl:3s,id:"minecraft:unbreaking"}]}}}] if score @s Res1 matches ..25 run scoreboard players add @s Var5 1
