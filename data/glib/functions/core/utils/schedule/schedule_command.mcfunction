...
execute as @e[tag=Valid] run function glib:core/utils/schedule/zzz_child/compute_tick
...
execute as @e[tag=Valid] run function glib:core/utils/schedule/zzz_child/schedule_command_rec
