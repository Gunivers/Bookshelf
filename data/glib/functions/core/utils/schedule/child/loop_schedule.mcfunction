...
execute at @e[tag=HeadGlibCache,tag=isEqual] run data modify block ~ ~1 ~ Command set value "execute as @e[tag=HeadGlibCache] at @s run function glib:core/utils/schedule/child/execute_commands"
