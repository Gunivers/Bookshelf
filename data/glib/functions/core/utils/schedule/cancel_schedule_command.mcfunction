...
# PATH: glib:utils/schedule/cancel_schedule_command
...
execute as @e[tag=Glib_Cache_Source] run function glib:core/utils/schedule/zzz_child/cancel_schedule_command_rec
