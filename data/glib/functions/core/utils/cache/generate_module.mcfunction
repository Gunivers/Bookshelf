...
# PATH: glib:core/cache/init_generate_module
...
# CODE:
execute as @e[tag=GenerateCacheGlib] at @s run setblock ~1 ~ ~-1 minecraft:structure_block[mode=load]{posX:3,name:"glib:utils/cache",rotation:"CLOCKWISE_180",mirror:"NONE",mode:"LOAD",ignoreEntities:0b} replace
