...
replaceitem entity @s[tag=Glib_Debug] hotbar.8 minecraft:barrier{display:{Name:"\"Gunivers Debugger (Drop to stop capture)\""}} 1
...
tag @a[tag=Glib_Menu_Menu] remove Glib_Debug
