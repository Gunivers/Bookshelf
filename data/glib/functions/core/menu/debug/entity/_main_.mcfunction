...
execute if entity @s[tag=Debug_E_Id] run function glib:core/menu/debug/entity/id/_main_
...
execute if entity @s[tag=Debug_E_Move] run function glib:core/menu/debug/entity/move/_main_
...
# execute if entity @s[tag=Debug_Entity_LocalVectors] run function glib:core/menu/debug/entity/local_vectors/_main_
...
execute if entity @s[tag=Debug_E_Vector] run function glib:core/menu/debug/entity/vector/_main_
