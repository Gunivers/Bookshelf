...
tellraw @s[tag=Debug_Entity_Move_By_Vector] ["",{"text":"           | ","color":"blue"},{"text":"[✔]","color":"green","clickEvent":{"action":"run_command","value":"/tag @s remove Debug_Entity_Move_By_Vector"},"hoverEvent":{"action":"show_text","value":"Remove this debug"}},{"text":" By vector","color":"gray","clickEvent":{"action":"run_command","value":"/tag @s remove Debug_Entity_Move_By_Vector"},"hoverEvent":{"action":"show_text","value":"Remove this debug"}}]
tellraw @s[tag=!Debug_Entity_Move_By_Vector] ["",{"text":"           | ","color":"blue"},{"text":"[x]","color":"red","clickEvent":{"action":"run_command","value":"/tag @s add Debug_Entity_Move_By_Vector"},"hoverEvent":{"action":"show_text","value":"Add this debug"}},{"text":" By vector","color":"gray","clickEvent":{"action":"run_command","value":"/tag @s add Debug_Entity_Move_By_Vector"},"hoverEvent":{"action":"show_text","value":"Add this debug"}}]
