...
execute as @e[tag=Projectile,tag=!Old] run function glib:entity/vector/get_by_actual_orientation 
scoreboard players set @e[tag=Projectile,tag=!Old] Collision 1

tag @e[tag=Projectile] add Old

execute as @e[tag=Projectile] run function glib:entity/move/by_vector
