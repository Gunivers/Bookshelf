...
execute if score @s BrushID matches 1 run function glib_child:mapedit/brush/set
execute if score @s BrushID matches 2 run function glib_child:mapedit/brush/replace
execute if score @s BrushID matches 3 run function glib_child:mapedit/brush/sphere
execute if score @s BrushID matches 4 run function glib_child:mapedit/brush/esphere
