...
# Original path: glib_accuracy:10-3/entity/location/set_y
...
execute if entity @s[type=minecraft:player] as @e[tag=SetLocation,limit=1] run function glib_child:entity/location/zzz_accuracy/10-3/set_y_player
