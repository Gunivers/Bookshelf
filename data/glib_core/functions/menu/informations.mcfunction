...
# CODE:
tellraw @s ["",{"text":"\n   x","bold":true,"color":"dark_red","clickEvent":{"action":"run_command","value":"/tag @s remove Glib_Menu.Informations"},"hoverEvent":{"action":"show_text","value":"Exit informations"}},{"text":"   ","color":"gold"},{"text":"Informations","underlined":true,"color":"gold"},{"text":"\n "}]

tellraw @s ["",{"text":"      "},{"text":"> Documentation","color":"green","clickEvent":{"action":"open_url","value":"https://project.gunivers.net/projects/gunivers-lib/wiki/documentation-en"},"hoverEvent":{"action":"show_text","value":"Read our documentation"}}]
