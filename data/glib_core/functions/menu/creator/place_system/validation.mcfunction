...
execute if entity @s[tag=Glib_Creator_Valid_System] as @e[tag=Glib_Example_System,limit=1,sort=nearest] at @s run function glib:object/block/convert/id_to_block
