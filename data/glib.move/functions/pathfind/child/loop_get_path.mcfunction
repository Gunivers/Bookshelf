...
execute unless entity @e[tag=Glib_Pathfind_Source,distance=..1.5] as @e[tag=Glib_Pathfind_Rewind_Head] at @s run function glib.move:pathfind/child/loop_get_path