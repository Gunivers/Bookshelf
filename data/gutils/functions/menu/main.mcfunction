...
function gutils:menu/creator/place_system/remove
execute as @s[tag=glib.menu.Debug] at @s run function gutils:menu/debug/main
execute as @s[tag=glib.menu.Creator] at @s run function gutils:menu/creator/main
execute as @s[tag=glib.menu.Rules] at @s run function gutils:menu/gamerule/rules
execute as @s[tag=glib.menu.Informations] at @s run function gutils:menu/informations
