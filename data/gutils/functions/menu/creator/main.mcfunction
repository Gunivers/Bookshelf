...
execute as @s[tag=Glib_Creator_system.] at @s run function gutils:menu/creator/example_systems/main
execute as @s[tag=Glib_Creator_platform] at @s run function gutils:menu/creator/base_platform/generate_base_confirm
execute as @s[tag=Glib_Creator_system.cache.place] at @s run function gutils:menu/creator/define_cache/place
execute as @s[tag=Glib_Creator_system.cache.remove] at @s run function gutils:menu/creator/define_cache/remove
