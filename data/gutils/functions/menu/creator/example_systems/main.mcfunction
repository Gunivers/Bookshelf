...
# Call system creator
execute if entity @s[tag=Glib_Creator_system.blackhole] run function gutils:menu/creator/example_systems/systems/blackhole
execute if entity @s[tag=Glib_Creator_system.lgdir] run function gutils:menu/creator/example_systems/systems/lgdir
