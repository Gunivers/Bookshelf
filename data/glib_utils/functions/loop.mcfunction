...
# Debug Recorder
execute as @a[tag=glib.debug.stick] run function glib_utils:menu/debug/debug_stick
execute as @a[tag=glib.debug,tag=glib.debug.global.display_tick] run function glib:core/debug/display_tick
execute as @a[tag=glib.debug,tag=glib.debug.entity.target_entity_manager,limit=1] at @s run function glib_utils:menu/debug/target_entity_manager
