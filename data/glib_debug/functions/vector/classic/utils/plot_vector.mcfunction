...
execute as @e[tag=glib.debug.plot_vector,limit=1,sort=nearest] run function glib_acc:10-3/location/get
...
execute as @e[tag=glib.debug.plot_vector,limit=1,sort=nearest] run function glib_acc:10-3/location/set
