...
execute if score @s glib.locX matches 1.. run function glib_child:10-3/location/fast_set/x_p
execute if score @s glib.locX matches ..-1 run function glib_child:10-3/location/fast_set/x_n
execute if score @s glib.locY matches 1.. run function glib_child:10-3/location/fast_set/y_p
execute if score @s glib.locY matches ..-1 run function glib_child:10-3/location/fast_set/y_n
execute if score @s glib.locZ matches 1.. run function glib_child:10-3/location/fast_set/z_p
execute if score @s glib.locZ matches ..-1 run function glib_child:10-3/location/fast_set/z_n
