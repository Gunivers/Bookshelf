...
# Original path: glib_acc:10-3/location/set_x
# Parallelizable: true
...
execute if entity @s[type=minecraft:player] as @e[tag=glib.new,limit=1] run function glib_child:10-3/location/set_x/player
