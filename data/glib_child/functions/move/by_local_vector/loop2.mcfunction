...
# DEBUG
execute if entity @a[tag=glib.debug,tag=Debug_Move_ByLocalVector,tag=!glib.menu] run function glib:debug/move/by_local_vector/3
# -----
...
execute as @s[tag=Move-Loop2] at @s run function glib_child:move/by_local_vector/loop2
