...
#Apply on entity
execute if entity @s[type=!player] at @s run function glib_child:move/by_vector/apply
...
execute if entity @s[type=player] at @s as @e[type=armor_stand,tag=Move_By_Vector,limit=1,sort=nearest] at @s run function glib_child:move/by_vector/apply
