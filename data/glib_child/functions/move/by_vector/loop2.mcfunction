...
execute if entity @s[type=!player,scores={glib.var3=1..}] at @s run function glib_child:move/by_vector/apply
...
execute if entity @s[type=player,scores={glib.var3=1..}] at @s as @e[type=armor_stand,tag=Move_By_Vector,limit=1,sort=nearest] at @s run function glib_child:move/by_vector/apply
...
execute as @s[scores={glib.var3=1..}] at @s run function glib_child:move/by_vector/loop2
