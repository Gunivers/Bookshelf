execute unless entity @e[tag=Glib_Pathfind_Stop] run function glib_config:entity/move/pathfind/possible_moves/main
...
# Loop
execute as @e[tag=Glib_Pathfind_Target,tag=!Glib_Pathfind_Stop] at @s as @e[tag=Glib_Pathfind_Move,tag=!Glib_Pathfind_Blocked,limit=1,sort=nearest] at @s run function glib_child:entity/move/pathfind/loop_search
