...
execute at @s as @e[type=area_effect_cloud,tag=Glib_Tmp_Collision_Detection,limit=1,sort=nearest] run function glib_accuracy:10-3/entity/location/get_y
...
#Detection
execute at @e[type=area_effect_cloud,tag=Glib_Tmp_Collision_Detection,limit=1,sort=nearest] if block ~ ~ ~ #glib_child:entity/move/by_vector/ignore_hitbox run tag @s remove CollisionY
