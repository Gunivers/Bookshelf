...
execute as @s[scores={Collision=1..}] at @s run function glib_child:entity/move/by_vector/collision_detect_front
tag @s remove Collision
execute as @s[scores={Collision=1..},tag=CollisionFront] at @s run function glib_child:entity/move/by_vector/collision
execute as @s[scores={Collision=1..},tag=CollisionTest] at @s run function glib_child:entity/move/by_vector/collision
...
execute if entity @s[type=!player,scores={glib.var3=1..}] at @s run function glib_child:entity/move/by_vector/apply
...
execute if entity @s[type=player,scores={glib.var3=1..}] at @s as @e[type=armor_stand,tag=Move_By_Vector,limit=1,sort=nearest] at @s run function glib_child:entity/move/by_vector/apply
...
execute as @s[scores={glib.var3=1..}] at @s run function glib_child:entity/move/by_vector/loop2
