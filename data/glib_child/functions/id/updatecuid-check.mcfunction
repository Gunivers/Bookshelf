...
execute as @e[tag=glib.id.chain.hasToMove,limit=1] run function glib_child:id/updatecuid-plug
...
execute as @e[tag=glib.id.chain.stacked] run function glib_child:id/updatecuid-unstack
...
execute as @e[tag=glib.id.chain.anotherLoop,limit=1] run function glib_child:id/updatecuid-check
