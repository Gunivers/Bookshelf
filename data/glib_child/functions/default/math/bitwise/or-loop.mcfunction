...
execute if score @s glib.var3 matches 1 run scoreboard players operation @s glib.res0 += @s glib.var2
...
execute unless score @s glib.var1 matches ..0 run function glib_child:default/math/bitwise/or-loop