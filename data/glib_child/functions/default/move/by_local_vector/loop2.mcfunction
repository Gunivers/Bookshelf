...
execute at @s run function glib_child:default/move/by_local_vector/apply

scoreboard players remove move.factor glib 1
execute at @s if score move.factor glib matches 1.. run function glib_child:default/move/by_local_vector/loop2
