...
execute as @s[scores={glib.collision=1..}] at @s run function glib_child:default/move/by_vector/collision_detect_x
tag @s[scores={glib.collision=1..},tag=glib.collisionX] add glib.collision

#__________________________________________________
# glib.collision on Y

execute as @s[scores={glib.collision=1..}] at @s run function glib_child:default/move/by_vector/collision_detect_y
tag @s[scores={glib.collision=1..},tag=glib.collisionY] add glib.collision

#__________________________________________________
# glib.collision on Z

execute as @s[scores={glib.collision=1..}] at @s run function glib_child:default/move/by_vector/collision_detect_z
...
execute if entity @s[tag=glib.collisionX,tag=glib.collisionZ] run function glib_child:default/move/by_vector/last_position
execute if entity @s[tag=glib.collisionX,tag=glib.collisionY,tag=!glib.move.by_vector.back_to_last_pos] run function glib_child:default/move/by_vector/last_position
execute if entity @s[tag=glib.collisionZ,tag=glib.collisionY,tag=!glib.move.by_vector.back_to_last_pos] run function glib_child:default/move/by_vector/last_position
...
execute if entity @s[tag=glib.collision] run function glib_config:move/by_vector/collision/_main_
