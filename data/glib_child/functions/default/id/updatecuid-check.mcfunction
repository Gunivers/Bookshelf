...
execute as @e[tag=glib.id.chain.stacked] run function glib_child:default/id/updatecuid-unstack
...
execute as @e[tag=glib.id.chain.anotherLoop,limit=1] run function glib_child:default/id/updatecuid-check
