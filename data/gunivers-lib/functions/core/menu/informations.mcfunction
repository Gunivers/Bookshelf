...
# CODE:
tellraw @s ["",{"text":"\n   x","bold":true,"color":"dark_red","clickEvent":{"action":"run_command","value":"/tag @s remove Glib_Menu_Informations"},"hoverEvent":{"action":"show_text","value":"Exit informations"}},{"text":"   ","color":"gold"},{"text":"Informations","underlined":true,"color":"gold"},{"text":"\n "}]
