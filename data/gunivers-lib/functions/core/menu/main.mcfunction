...
execute as @s[tag=Glib_Menu_Debug] at @s run function gunivers-lib:core/menu/debug
execute as @s[tag=Glib_Menu_Creator] at @s run function gunivers-lib:core/menu/creator/creator
execute as @s[tag=Glib_Menu_Rules] at @s run function gunivers-lib:core/menu/gamerule/rules
execute as @s[tag=Glib_Menu_Informations] at @s run function gunivers-lib:core/menu/informations
