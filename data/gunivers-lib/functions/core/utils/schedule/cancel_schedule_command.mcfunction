...
# CODE:
function gunivers-lib:core/utils/cache/select_jukebox
...
execute as @e[tag=ASGlibCache] run function gunivers-lib:core/utils/schedule/child/cancel_schedule_command_rec
