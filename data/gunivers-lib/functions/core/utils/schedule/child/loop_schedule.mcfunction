...
function gunivers-lib:core/utils/cache/select_command_block
...
execute at @e[tag=HeadGlibCache,tag=isEqual] run data modify block ~ ~1 ~ Command set value "execute as @e[tag=HeadGlibCache] at @s run function gunivers-lib:core/utils/schedule/child/execute_commands"
