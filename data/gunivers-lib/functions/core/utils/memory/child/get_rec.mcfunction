...
# PATH: gunivers-lib:utils/memory/child/get_rec

# AUTHOR: theogiraudet

# CHILD OF: gunivers-lib:utils/memory/get
...
execute if score @s Var1 matches 1 if data entity @s ArmorItems[0].tag.Buffer2[0] run function gunivers-lib:core/utils/memory/child/get_rec