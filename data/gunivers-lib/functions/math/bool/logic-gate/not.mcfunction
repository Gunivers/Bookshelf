...
execute if score Input1 Input = -1 Constant run scoreboard players set Output-1 Output -1
execute if score Input1 Input = 1 Constant run scoreboard players set Output1 Output 1
execute if score Input1 Input = 0 Constant run scoreboard players set Output1 Output 0
