...
execute as @s[tag=Glib_Menu_Examples] at @s run function gunivers-lib:utils/menu/creator/examples

execute as @s[tag=Glib_Menu_Cache_Ghost] at @s run function gunivers-lib:utils/cache/generate_module_ghost
execute as @s[tag=Glib_Menu_Platform_Confirm] at @s run function gunivers-lib:utils/menu/creator/generate_base_confirm