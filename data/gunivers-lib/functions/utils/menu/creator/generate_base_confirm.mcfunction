...
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~32 ~ ~32 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~32 ~ ~-16 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~-16 ~ ~32 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~-16 ~ ~-16 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}

execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~16 ~ ~16 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~16 ~ ~ {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~ ~ ~16 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~ ~ ~ {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}

execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~16 ~ ~32 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~32 ~ ~16 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~ ~ ~32 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~32 ~ ~ {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~16 ~ ~-16 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~ ~ ~-16 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
execute as @e[type=armor_stand,tag=Glib_Generate_Base,limit=1] at @s positioned ~ ~-1 ~ run summon minecraft:falling_block ~-16 ~ ~16 {BlockState:{Name:"minecraft:black_concrete"},NoGravity:1b,Time:595}
