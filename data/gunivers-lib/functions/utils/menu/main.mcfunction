...
execute as @s[tag=Glib_Menu_Debug] at @s run function gunivers-lib:utils/menu/debug
execute as @s[tag=Glib_Menu_Creator] at @s run function gunivers-lib:utils/menu/creator/creator
execute as @s[tag=Glib_Menu_Rules] at @s run function gunivers-lib:utils/menu/gamerule/rules
execute as @s[tag=Glib_Menu_Informations] at @s run function gunivers-lib:utils/menu/informations
