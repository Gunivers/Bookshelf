...
execute if score @s Var0 matches 1 if data entity @s ArmorItems[0].tag.Buffer2[0] run function gunivers-lib:utils/schedule/child/cancel_schedule_command_rec