...
# PATH: gunivers-lib:collections/lists/fifo_list/fifo_list_to_buffer
...
data modify entity @s[scores={Var2=1}] ArmorItems[2].tag.buffer set from entity @s ArmorItems[2].tag.fifo