...
# PATH: gunivers-lib:collections/lists/fifo_list/get_index_of
...
function gunivers-lib:collections/lists/fifo_list/fifo_list_to_buffer
scoreboard players set @s Res 0
scoreboard players set @s Var4 0
scoreboard players operation @s Var5 = @s Var1
function gunivers-lib:collections/lists/fifo_list/get_index_of_rec
function gunivers-lib:collections/lists/fifo_list/buffer_to_fifo_list
