...
execute if score @s BrushID matches 1 run function gunivers-lib:object/mapedit/child/brush/set
execute if score @s BrushID matches 2 run function gunivers-lib:object/mapedit/child/brush/replace
execute if score @s BrushID matches 3 run function gunivers-lib:object/mapedit/child/brush/sphere
execute if score @s BrushID matches 4 run function gunivers-lib:object/mapedit/child/brush/esphere
