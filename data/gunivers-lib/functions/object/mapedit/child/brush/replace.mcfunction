...
execute at @s run function gunivers-lib:object/convert/block/block_to_id
...
execute if score @s ActualBlockID = @s OriginalId run function gunivers-lib:object/convert/block/id_to_block