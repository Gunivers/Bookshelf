...
# Res = r^2 = distance^2
execute as @s at @e[tag=SourceOfGravity,limit=1,tag=GravitySelect] run function gunivers-lib:entity/location/accuracy/10-3/10-1/get_distance_squared_as_to_at
