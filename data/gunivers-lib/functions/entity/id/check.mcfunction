...
execute as @e run tellraw @a[tag=Glib_Debug,tag=Debug_Entity_Id_Check] ["",{"text":"CALCUL -> ","color":"gray"},{"text":"Id: ","color":"red"},{"score":{"name":"@s","objective":"Id"}},{"text":"   Result: ","color":"red"},{"score":{"name":"@s","objective":"Var1"}}]
