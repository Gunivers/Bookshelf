# NAME: Can Rain
# PATH: gunivers-lib:entity/location/temperature/cain_rain
...
execute if score @s Temperature matches 15000000..95000000 run scoreboard players set @s Var1 1
execute if score @s Temperature matches 100000000.. run scoreboard players set @s Var1 0
execute if score @s Temperature matches 14000000.. run scoreboard players set @s Var1 0