...
scoreboard players operation @s[scores={Collision=1..3},tag=CollisionX] VectorRight *= Neg Constant
...
scoreboard players set @s[scores={Collision=4},tag=CollisionX] VectorRight 0
...
scoreboard players operation @s[scores={Collision=1},tag=CollisionY] VectorUp *= Neg Constant
...
scoreboard players set @s[scores={Collision=2..4},tag=CollisionY] VectorUp 0
...
scoreboard players operation @s[scores={Collision=1..3},tag=CollisionZ] VectorFront *= Neg Constant
...
scoreboard players set @s[scores={Collision=4},tag=CollisionZ] VectorFront 0
