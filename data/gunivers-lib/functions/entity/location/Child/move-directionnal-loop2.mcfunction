...
execute as @s[scores={Collision=1..99}] at @s run function gunivers-lib:entity/location/child/move-directionnal-collision
execute as @s[scores={Collision=100..199}] at @s run function gunivers-lib:entity/location/child/move-directionnal-collision-simple
function gunivers-lib:entity/location/child/move-directionnal-child

scoreboard players remove @s Var4 1

tag @s remove Move-Loop2
tag @s[scores={Var4=1..}] add Move-Loop2
execute as @s[tag=Move-Loop2] at @s run function gunivers-lib:entity/location/child/move-directionnal-loop2