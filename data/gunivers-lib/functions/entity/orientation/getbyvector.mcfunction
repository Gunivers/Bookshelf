# NAME: Get Orientation By Vector
# PATH: gunivers-lib:entity/orientation/getbyvector
...
execute as @e[type=armor_stand,tag=GLib-GetObV] run function gunivers-lib:entity/orientation/get
