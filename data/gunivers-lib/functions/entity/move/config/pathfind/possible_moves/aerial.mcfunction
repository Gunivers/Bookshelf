...
#X
execute positioned ~1 ~ ~ unless entity @e[tag=Glib_Pathfind,distance=..0.7] if block ~ ~ ~ air run summon armor_stand ~ ~ ~ {NoGravity:1,Marker:1,Small:1,Invisible:1,Tags:["Glib","Glib_Pathfind_Move","Glib_Pathfind"]}
