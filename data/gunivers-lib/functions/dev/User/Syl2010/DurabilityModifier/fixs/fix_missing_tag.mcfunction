...
# NAME: Durability Modifier - Missing tag fix
# PATH: gunivers-lib:dev/User/Syl2010/DurabilityModifier/fixs/fix_missing_tag
...
# NOTE: 
# Remplace l'item tenu en main par le joueur (@s) par une version de l'item possédant un tag par défaut 
# (permet à l'item d'être modifié grâce à la comande `execute store`)
