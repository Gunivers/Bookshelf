...
from core.common.metadata import get_feature_meta, get_module_meta
...
def main():
    ...
    """
    with log_step('⏳ Checking module metadata files…') as module_logger:
        for module in MODULES_DIR.iterdir():
            get_module_meta(module / 'module.json', module_logger)

    with log_step('⏳ Checking feature metadata files…') as feature_logger:
