...
execute as B5-0-0-0-1 at @s run tp @s ~-.000000001 ~-.000000001 ~-.000000001
...
execute at B5-0-0-0-1 align xyz run function bs.move:collision/recurse/x/nnn with storage bs:in move
