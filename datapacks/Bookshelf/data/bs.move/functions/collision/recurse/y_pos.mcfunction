...
scoreboard players add #move.ry bs.data 1000000
execute if score #move.ry bs.data < #move.y2 bs.data positioned ~ ~1 ~ run function bs.move:collision/recurse/y_pos
