...
execute if score @s bs.var3 matches 1 run scoreboard players operation @s bs.res0 += @s bs.var2
...
execute unless score @s bs.var1 matches ..0 run function bs.math:bitwise/or/child/loop