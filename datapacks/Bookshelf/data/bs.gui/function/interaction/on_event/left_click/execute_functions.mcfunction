...
#
# Input:
#  - bs:in gui.callbacks: The list of callbacks linked to the current interaction for the left click event.
...
execute as @e[tag=bs.gui.executor] run function bs.gui:interaction/on_event/left_click/execute_function with storage bs:ctx _
