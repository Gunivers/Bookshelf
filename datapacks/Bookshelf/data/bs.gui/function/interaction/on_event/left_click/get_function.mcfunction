...
$execute if data storage bs:data gui.listener.$(id).left_click run data modify storage bs:out gui.callbacks set from storage bs:data gui.listener.$(id).left_click