...
# Call system creator
execute if entity @s[tag=bs_Creator_system.blackhole] run function bs:menu/creator/example_systems/systems/blackhole
execute if entity @s[tag=bs_Creator_system.lgdir] run function bs:menu/creator/example_systems/systems/lgdir
