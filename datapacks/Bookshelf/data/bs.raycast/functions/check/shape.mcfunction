...
scoreboard players operation #raycast.min_x bs.data += $hitbox.offset_x bs.out
scoreboard players operation #raycast.max_x bs.data += $hitbox.offset_x bs.out
scoreboard players operation #raycast.min_z bs.data += $hitbox.offset_z bs.out
scoreboard players operation #raycast.max_z bs.data += $hitbox.offset_z bs.out

# when step is negative we need to reverse near and far points
execute if score #raycast.ux bs.data matches ..-1 run scoreboard players remove #raycast.min_x bs.data 1000000
execute if score #raycast.ux bs.data matches ..-1 run scoreboard players remove #raycast.max_x bs.data 1000000
...
execute if score #raycast.uy bs.data matches ..-1 run scoreboard players remove #raycast.min_y bs.data 1000000
execute if score #raycast.uy bs.data matches ..-1 run scoreboard players remove #raycast.max_y bs.data 1000000
...
execute if score #raycast.uz bs.data matches ..-1 run scoreboard players remove #raycast.min_z bs.data 1000000
execute if score #raycast.uz bs.data matches ..-1 run scoreboard players remove #raycast.max_z bs.data 1000000
