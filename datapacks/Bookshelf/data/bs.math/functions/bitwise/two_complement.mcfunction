...
execute if score @s bs.var0 matches ..-1 run tag @s add bs.math.bitwise.two_complement.negative
execute if entity @s[tag=bs.math.bitwise.two_complement.negative] run scoreboard players operation @s bs.var0 *= -1 bs.const
...
execute if entity @s[tag=bs.math.bitwise.two_complement.negative] run scoreboard players operation @s bs.var0 *= -1 bs.const
tag @s remove bs.math.bitwise.two_complement.negative
