...
execute if score @s bs.var0 matches ..-1 unless score @s bs.var1 matches ..-1 run tag @s add bs.math.bitwise.xor.negative_operors
execute if score @s bs.var1 matches ..-1 unless score @s bs.var0 matches ..-1 run tag @s add bs.math.bitwise.xor.negative_operors
...
function bs.math:bitwise/xor/child/loop

execute if entity @s[tag=bs.math.bitwise.xor.negative_operors] run scoreboard players operation @s bs.var0 = @s bs.res0
execute if entity @s[tag=bs.math.bitwise.xor.negative_operors] run function bs.math:bitwise/two_complement
execute if entity @s[tag=bs.math.bitwise.xor.negative_operors] run scoreboard players operation @s bs.res0 *= -1 bs.const

tag @s remove bs.math.bitwise.xor.negative_operors
