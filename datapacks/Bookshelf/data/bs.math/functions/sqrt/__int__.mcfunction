...
execute if score @s bs.in.0 matches ..13924 run function bs.math:sqrt/int_part_1
execute if score @s bs.in.0 matches 13925..16777216 run function bs.math:sqrt/int_part_2
execute if score @s bs.in.0 matches 16777217.. run function bs.math:sqrt/int_part_3
