# is E >= 12
execute store result score #math.sqrt.__check_3 bs.data run data get storage bs:in math.sqrt.value 0.000244140625
# is E >= 8
execute store result score #math.sqrt.__check_2 bs.data run data get storage bs:in math.sqrt.value 0.00390625
# is E >= 4
execute store result score #math.sqrt.__check_1 bs.data run data get storage bs:in math.sqrt.value 0.0625
