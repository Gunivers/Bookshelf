# if E = -89
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 664613997892457936451903530140172288
...
# elif E = -90
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 1329227995784915872903807060280344576
execute if score #math.sqrt.in bs.data matches 1073741824.. run function bs.math:sqrt/calc_even
execute if score #math.sqrt.in bs.data matches 1073741824.. store result storage bs:out math.sqrt float 0.00000000000000000000005293955920339377119177015629247762262821197509765625 run scoreboard players get #math.sqrt.out bs.data
execute if score #math.sqrt.in bs.data matches 1073741824.. run return 0
# elif E = -91
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 2658455991569831745807614120560689152
execute if score #math.sqrt.in bs.data matches 1073741824.. run function bs.math:sqrt/calc_odd
...
execute if score #math.sqrt.in bs.data matches 1073741824.. run return 0
# elif E = -92
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 5316911983139663491615228241121378304
