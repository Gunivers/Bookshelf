# is E >= -84
execute store result score #math.sqrt.__check_3 bs.data run data get storage bs:in math.sqrt 19342813113834066795298816
# is E >= -88
execute store result score #math.sqrt.__check_2 bs.data run data get storage bs:in math.sqrt 309485009821345068724781056
# is E >= -92
execute store result score #math.sqrt.__check_1 bs.data run data get storage bs:in math.sqrt 4951760157141521099596496896
