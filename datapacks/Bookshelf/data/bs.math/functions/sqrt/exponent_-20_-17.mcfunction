# if E = -17
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 140737488355328
...
# elif E = -18
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 281474976710656
execute if score #math.sqrt.in bs.data matches 1073741824.. run function bs.math:sqrt/calc_even
execute if score #math.sqrt.in bs.data matches 1073741824.. store result storage bs:out math.sqrt float 0.00000000000363797880709171295166015625 run scoreboard players get #math.sqrt.out bs.data
execute if score #math.sqrt.in bs.data matches 1073741824.. run return 0
# elif E = -19
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 562949953421312
execute if score #math.sqrt.in bs.data matches 1073741824.. run function bs.math:sqrt/calc_odd
...
execute if score #math.sqrt.in bs.data matches 1073741824.. run return 0
# elif E = -20
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 1125899906842624
