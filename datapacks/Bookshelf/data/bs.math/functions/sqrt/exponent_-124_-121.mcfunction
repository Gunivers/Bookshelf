# if E = -121
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 2854495385411919762116571938898990272765493248
...
# elif E = -122
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 5708990770823839524233143877797980545530986496
execute if score #math.sqrt.in bs.data matches 1073741824.. run function bs.math:sqrt/calc_even
execute if score #math.sqrt.in bs.data matches 1073741824.. store result storage bs:out math.sqrt float 0.000000000000000000000000000807793566946316088741610050849573099185363389551639556884765625 run scoreboard players get #math.sqrt.out bs.data
execute if score #math.sqrt.in bs.data matches 1073741824.. run return 0
# elif E = -123
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 11417981541647679048466287755595961091061972992
execute if score #math.sqrt.in bs.data matches 1073741824.. run function bs.math:sqrt/calc_odd
...
execute if score #math.sqrt.in bs.data matches 1073741824.. run return 0
# elif E = -124
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 22835963083295358096932575511191922182123945984
