# is E >= -52
execute store result score #math.sqrt.__check_3 bs.data run data get storage bs:in math.sqrt.value 4503599627370496
# is E >= -56
execute store result score #math.sqrt.__check_2 bs.data run data get storage bs:in math.sqrt.value 72057594037927936
# is E >= -60
execute store result score #math.sqrt.__check_1 bs.data run data get storage bs:in math.sqrt.value 1152921504606846976
