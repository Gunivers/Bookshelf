# is E >= -16
execute store result score #math.sqrt._check_3 bs.data run data get storage bs.in math.sqrt 65536
# is E >= -32
execute store result score #math.sqrt._check_2 bs.data run data get storage bs.in math.sqrt 4294967296
# is E >= -48
execute store result score #math.sqrt._check_1 bs.data run data get storage bs.in math.sqrt 281474976710656
