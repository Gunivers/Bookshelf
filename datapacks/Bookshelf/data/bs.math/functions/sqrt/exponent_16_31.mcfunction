# is E >= 28
execute store result score #math.sqrt.__check_3 bs.data run data get storage bs:in math.sqrt.value 0.0000000037252902984619140625
# is E >= 24
execute store result score #math.sqrt.__check_2 bs.data run data get storage bs:in math.sqrt.value 0.000000059604644775390625
# is E >= 20
execute store result score #math.sqrt.__check_1 bs.data run data get storage bs:in math.sqrt.value 0.00000095367431640625
