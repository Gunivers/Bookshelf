# is E >= -116
execute store result score #math.sqrt.__check_3 bs.data run data get storage bs:in math.sqrt.value 83076749736557242056487941267521536
# is E >= -120
execute store result score #math.sqrt.__check_2 bs.data run data get storage bs:in math.sqrt.value 1329227995784915872903807060280344576
# is E >= -124
execute store result score #math.sqrt.__check_1 bs.data run data get storage bs:in math.sqrt.value 21267647932558653966460912964485513216
