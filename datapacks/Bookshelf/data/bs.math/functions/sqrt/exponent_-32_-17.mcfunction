# is E >= -20
execute store result score #math.sqrt.__check_3 bs.data run data get storage bs:in math.sqrt.value 1048576
# is E >= -24
execute store result score #math.sqrt.__check_2 bs.data run data get storage bs:in math.sqrt.value 16777216
# is E >= -28
execute store result score #math.sqrt.__check_1 bs.data run data get storage bs:in math.sqrt.value 268435456
