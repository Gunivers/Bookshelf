# if E = -105
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 43556142965880123323311949751266331066368
...
# elif E = -106
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 87112285931760246646623899502532662132736
execute if score #math.sqrt.in bs.data matches 1073741824.. run function bs.math:sqrt/calc_even
execute if score #math.sqrt.in bs.data matches 1073741824.. store result storage bs:out math.sqrt float 0.0000000000000000000000002067951531382569187178521730174907133914530277252197265625 run scoreboard players get #math.sqrt.out bs.data
execute if score #math.sqrt.in bs.data matches 1073741824.. run return 0
# elif E = -107
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 174224571863520493293247799005065324265472
execute if score #math.sqrt.in bs.data matches 1073741824.. run function bs.math:sqrt/calc_odd
...
execute if score #math.sqrt.in bs.data matches 1073741824.. run return 0
# elif E = -108
execute store result score #math.sqrt.in bs.data run data get storage bs:in math.sqrt.value 348449143727040986586495598010130648530944
