# is E >= -36
execute store result score #math.sqrt.__check_3 bs.data run data get storage bs:in math.sqrt.value 68719476736
# is E >= -40
execute store result score #math.sqrt.__check_2 bs.data run data get storage bs:in math.sqrt.value 1099511627776
# is E >= -44
execute store result score #math.sqrt.__check_1 bs.data run data get storage bs:in math.sqrt.value 17592186044416
