# is E >= -100
execute store result score #math.sqrt.__check_3 bs.data run data get storage bs:in math.sqrt 1267650600228229401496703205376
# is E >= -104
execute store result score #math.sqrt.__check_2 bs.data run data get storage bs:in math.sqrt 20282409603651670423947251286016
# is E >= -108
execute store result score #math.sqrt.__check_1 bs.data run data get storage bs:in math.sqrt 324518553658426726783156020576256
