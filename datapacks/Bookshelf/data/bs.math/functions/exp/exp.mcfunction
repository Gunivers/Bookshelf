...
execute store result storage bs:data math.exp.index int 1 run scoreboard players add #math.exp.index bs.data 7
...
execute if score #math.exp.index bs.data matches 0.. run function bs.math:exp/table with storage bs:data math.exp
