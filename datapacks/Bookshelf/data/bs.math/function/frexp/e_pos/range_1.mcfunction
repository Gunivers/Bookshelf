...
execute unless score #math.frexp.x bs.data matches -8388607..8388607 run return run scoreboard players set #math.frexp.e bs.data 112
execute store result score #math.frexp.x bs.data run data get storage bs:ctx x .00000000000000000000000082718061255302767487140869206996285356581211090087890625
execute unless score #math.frexp.x bs.data matches -8388607..8388607 run return run scoreboard players set #math.frexp.e bs.data 104
...
execute unless score #math.frexp.x bs.data matches -8388607..8388607 run return run scoreboard players set #math.frexp.e bs.data 96
