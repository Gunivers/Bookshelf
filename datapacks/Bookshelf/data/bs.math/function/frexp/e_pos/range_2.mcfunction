...
execute unless score #math.frexp.x bs.data matches -8388607..8388607 run return run scoreboard players set #math.frexp.e bs.data 80
execute store result score #math.frexp.x bs.data run data get storage bs:ctx x .000000000000003552713678800500929355621337890625
execute unless score #math.frexp.x bs.data matches -8388607..8388607 run return run scoreboard players set #math.frexp.e bs.data 72
execute store result score #math.frexp.x bs.data run data get storage bs:ctx x .0000000000009094947017729282379150390625
execute unless score #math.frexp.x bs.data matches -8388607..8388607 run return run scoreboard players set #math.frexp.e bs.data 64
