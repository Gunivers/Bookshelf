...
tellraw @a[tag=glib.menu.debug.math.algebra,scores={glib.menu.page = 0},tag=!glib.debug.math.algebra.basis_rotation_3d] ["", {"text": "   basis_rotation_3d: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.math.algebra.basis_rotation_3d"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.math.algebra.basis_rotation_3d"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}]
tellraw @a[tag=glib.menu.debug.math.algebra,scores={glib.menu.page = 0},tag=glib.debug.math.algebra.basis_rotation_3d] ["", {"text": "   basis_rotation_3d: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.math.algebra.basis_rotation_3d"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.math.algebra.basis_rotation_3d"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}]
