...
# Original path: bs.orientation:get_v/accuracy/10-3
# Parallelizable: true
...
execute store result score @s bs.ori.v run data get entity @e[tag=bs.new,limit=1,sort=nearest] Rotation[1] 1000
