...
# CODE:
summon armor_stand ~ ~ ~ {NoGravity:1b,Invisible:1b,Marker:1b,Tags:["bs","New","Memory"],ArmorItems:[{id:"minecraft:slime_ball",Count:1b,tag:{Memory:[]}},{},{},{}]}
schedule function bs_child:default/core/memory/remove_new_tag 1t