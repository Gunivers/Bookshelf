...
data modify storage bs:out block._[].options[]._ set value 0b
...
data remove storage bs:out block._[].options[{_:0b}].selected
data remove storage bs:out block._[].options[]._
