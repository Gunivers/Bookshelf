# retrieve state and properties data from the iterable_properties
data modify storage bs:out block merge value {state:[],properties:{}}
data modify storage bs:out block.state append from storage bs:out block.iterable_properties[].options[{selected:1b}].state
data modify storage bs:out block.properties merge from storage bs:out block.iterable_properties[].options[{selected:1b}].property
