...
execute if block ~ ~ ~ #bs.block:has_state[leaves=none] run data modify storage bs:out block._[{name:"leaves"}].options[{value:"none"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[leaves=small] run data modify storage bs:out block._[{name:"leaves"}].options[{value:"small"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[leaves=large] run data modify storage bs:out block._[{name:"leaves"}].options[{value:"large"}].selected set value 1b
