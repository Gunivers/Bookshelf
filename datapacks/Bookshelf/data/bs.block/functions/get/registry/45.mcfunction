...
execute if block ~ ~ ~ #bs.block:has_state[conditional=false] run data modify storage bs:out block._[{name:"conditional"}].options[{value:"false"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[conditional=true] run data modify storage bs:out block._[{name:"conditional"}].options[{value:"true"}].selected set value 1b
