...
execute if block ~ ~ ~ #bs.block:has_state[delay=1] run data modify storage bs:out block.iterable_properties[{name:"delay"}].options[{value:"1"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[delay=2] run data modify storage bs:out block.iterable_properties[{name:"delay"}].options[{value:"2"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[delay=3] run data modify storage bs:out block.iterable_properties[{name:"delay"}].options[{value:"3"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[delay=4] run data modify storage bs:out block.iterable_properties[{name:"delay"}].options[{value:"4"}].selected set value 1b
...
execute if block ~ ~ ~ #bs.block:has_state[locked=false] run data modify storage bs:out block.iterable_properties[{name:"locked"}].options[{value:"false"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[locked=true] run data modify storage bs:out block.iterable_properties[{name:"locked"}].options[{value:"true"}].selected set value 1b
