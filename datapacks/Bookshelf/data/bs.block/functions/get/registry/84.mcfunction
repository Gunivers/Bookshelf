...
execute if block ~ ~ ~ #bs.block:has_state[type=normal] run data modify storage bs:out block._[{name:"type"}].options[{value:"normal"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[type=sticky] run data modify storage bs:out block._[{name:"type"}].options[{value:"sticky"}].selected set value 1b
...
execute if block ~ ~ ~ #bs.block:has_state[short=false] run data modify storage bs:out block._[{name:"short"}].options[{value:"false"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[short=true] run data modify storage bs:out block._[{name:"short"}].options[{value:"true"}].selected set value 1b
