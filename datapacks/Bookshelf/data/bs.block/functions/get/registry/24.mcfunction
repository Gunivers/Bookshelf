...
execute if block ~ ~ ~ #bs.block:has_state[attachment=floor] run data modify storage bs:out block.iterable_properties[{name:"attachment"}].options[{value:"floor"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[attachment=ceiling] run data modify storage bs:out block.iterable_properties[{name:"attachment"}].options[{value:"ceiling"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[attachment=single_wall] run data modify storage bs:out block.iterable_properties[{name:"attachment"}].options[{value:"single_wall"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[attachment=double_wall] run data modify storage bs:out block.iterable_properties[{name:"attachment"}].options[{value:"double_wall"}].selected set value 1b
