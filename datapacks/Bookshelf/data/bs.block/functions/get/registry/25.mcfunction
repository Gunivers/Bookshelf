...
execute if block ~ ~ ~ #bs.block:has_state[tilt=none] run data modify storage bs:out block._[{name:"tilt"}].options[{value:"none"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[tilt=unstable] run data modify storage bs:out block._[{name:"tilt"}].options[{value:"unstable"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[tilt=partial] run data modify storage bs:out block._[{name:"tilt"}].options[{value:"partial"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[tilt=full] run data modify storage bs:out block._[{name:"tilt"}].options[{value:"full"}].selected set value 1b
