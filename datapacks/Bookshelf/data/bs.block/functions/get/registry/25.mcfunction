...
execute if block ~ ~ ~ #bs.block:has_state[tilt=none] run data modify storage bs:out block._[{n:"tilt"}].o[{v:"none"}].c set value 1b
execute if block ~ ~ ~ #bs.block:has_state[tilt=unstable] run data modify storage bs:out block._[{n:"tilt"}].o[{v:"unstable"}].c set value 1b
execute if block ~ ~ ~ #bs.block:has_state[tilt=partial] run data modify storage bs:out block._[{n:"tilt"}].o[{v:"partial"}].c set value 1b
execute if block ~ ~ ~ #bs.block:has_state[tilt=full] run data modify storage bs:out block._[{n:"tilt"}].o[{v:"full"}].c set value 1b
