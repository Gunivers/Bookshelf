...
execute if block ~ ~ ~ #bs.block:has_state[type=single] run data modify storage bs:out block._[{name:"type"}].options[{value:"single"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[type=left] run data modify storage bs:out block._[{name:"type"}].options[{value:"left"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[type=right] run data modify storage bs:out block._[{name:"type"}].options[{value:"right"}].selected set value 1b
