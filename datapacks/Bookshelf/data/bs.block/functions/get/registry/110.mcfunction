...
execute if block ~ ~ ~ #bs.block:has_state[vault_state=inactive] run data modify storage bs:out block.iterable_properties[{name:"vault_state"}].options[{value:"inactive"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[vault_state=active] run data modify storage bs:out block.iterable_properties[{name:"vault_state"}].options[{value:"active"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[vault_state=unlocking] run data modify storage bs:out block.iterable_properties[{name:"vault_state"}].options[{value:"unlocking"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[vault_state=ejecting] run data modify storage bs:out block.iterable_properties[{name:"vault_state"}].options[{value:"ejecting"}].selected set value 1b
