...
execute if block ~ ~ ~ #bs.block:has_state[hanging=false] run data modify storage bs:out block.iterable_properties[{name:"hanging"}].options[{value:"false"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[hanging=true] run data modify storage bs:out block.iterable_properties[{name:"hanging"}].options[{value:"true"}].selected set value 1b
