...
execute if block ~ ~ ~ #bs.block:has_state[shape=south_east] run data modify storage bs:out block.iterable_properties[{name:"shape"}].options[{value:"south_east"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[shape=south_west] run data modify storage bs:out block.iterable_properties[{name:"shape"}].options[{value:"south_west"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[shape=north_west] run data modify storage bs:out block.iterable_properties[{name:"shape"}].options[{value:"north_west"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[shape=north_east] run data modify storage bs:out block.iterable_properties[{name:"shape"}].options[{value:"north_east"}].selected set value 1b
