...
execute if block ~ ~ ~ #bs.block:has_state[attached=false] run data modify storage bs:out block._[{name:"attached"}].options[{value:"false"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[attached=true] run data modify storage bs:out block._[{name:"attached"}].options[{value:"true"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[disarmed=false] run data modify storage bs:out block._[{name:"disarmed"}].options[{value:"false"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[disarmed=true] run data modify storage bs:out block._[{name:"disarmed"}].options[{value:"true"}].selected set value 1b
