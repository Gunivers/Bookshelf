...
execute if block ~ ~ ~ #bs.block:has_state[occupied=false] run data modify storage bs:out block._[{name:"occupied"}].options[{value:"false"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[occupied=true] run data modify storage bs:out block._[{name:"occupied"}].options[{value:"true"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[part=foot] run data modify storage bs:out block._[{name:"part"}].options[{value:"foot"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[part=head] run data modify storage bs:out block._[{name:"part"}].options[{value:"head"}].selected set value 1b
