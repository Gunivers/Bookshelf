...
execute if block ~ ~ ~ #bs.block:has_state[candles=1] run data modify storage bs:out block._[{name:"candles"}].options[{value:"1"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[candles=2] run data modify storage bs:out block._[{name:"candles"}].options[{value:"2"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[candles=3] run data modify storage bs:out block._[{name:"candles"}].options[{value:"3"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[candles=4] run data modify storage bs:out block._[{name:"candles"}].options[{value:"4"}].selected set value 1b
