...
execute if block ~ ~ ~ #bs.block:has_state[signal_fire=false] run data modify storage bs:out block._[{n:"signal_fire"}].o[{v:"false"}].c set value 1b
execute if block ~ ~ ~ #bs.block:has_state[signal_fire=true] run data modify storage bs:out block._[{n:"signal_fire"}].o[{v:"true"}].c set value 1b
