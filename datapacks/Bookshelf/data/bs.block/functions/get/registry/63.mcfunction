...
execute if block ~ ~ ~ #bs.block:has_state[down=false] run data modify storage bs:out block.iterable_properties[{name:"down"}].options[{value:"false"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[down=true] run data modify storage bs:out block.iterable_properties[{name:"down"}].options[{value:"true"}].selected set value 1b
