...
execute if block ~ ~ ~ #bs.block:has_state[hinge=left] run data modify storage bs:out block._[{name:"hinge"}].options[{value:"left"}].selected set value 1b
execute if block ~ ~ ~ #bs.block:has_state[hinge=right] run data modify storage bs:out block._[{name:"hinge"}].options[{value:"right"}].selected set value 1b
