...
execute if block ~ ~ ~ #bs.block:has_state[persistent=false] run data modify storage bs:out block._[{n:"persistent"}].o[{v:"false"}].c set value 1b
execute if block ~ ~ ~ #bs.block:has_state[persistent=true] run data modify storage bs:out block._[{n:"persistent"}].o[{v:"true"}].c set value 1b
