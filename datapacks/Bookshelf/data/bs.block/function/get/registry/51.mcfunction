...
execute if block ~ ~ ~ #bs.block:has_state[mode=compare] run data modify storage bs:out block._[{n:"mode"}].o[{v:"compare"}].c set value 1b
execute if block ~ ~ ~ #bs.block:has_state[mode=subtract] run data modify storage bs:out block._[{n:"mode"}].o[{v:"subtract"}].c set value 1b
