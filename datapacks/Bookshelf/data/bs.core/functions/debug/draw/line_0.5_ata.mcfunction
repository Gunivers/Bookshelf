...
execute unless entity @e[tag=bs.debug.draw_line,distance=..0.5] as @e[tag=bs.debug.draw_line,limit=1,sort=nearest] run function bs.core:debug/draw/line_0.5/child/line_0.5
