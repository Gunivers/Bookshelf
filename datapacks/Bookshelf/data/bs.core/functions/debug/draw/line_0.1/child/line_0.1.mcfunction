...
execute if score debug.draw_line bs.var0 matches ..0 run kill @s
execute as @s unless entity @s[distance=..0.1] run function bs.core:debug/draw/line_0.1/child/line_0.1
