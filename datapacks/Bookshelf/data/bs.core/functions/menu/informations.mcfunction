...
tellraw @s ["",{"text":"      "},{"text":"> Documentation","color":"green","clickEvent":{"action":"open_url","value":"https://bs-core.readthedocs.io//documentation-en"},"hoverEvent":{"action":"show_text","value":"Read our documentation"}}]
