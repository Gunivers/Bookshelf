...
execute as @s[tag=Glib_Creator_system.] at @s run function bs.core:menu/creator/example_systems/main
execute as @s[tag=Glib_Creator_platform] at @s run function bs.core:menu/creator/base_platform/generate_base_confirm
execute as @s[tag=Glib_Creator_system.cache.place] at @s run function bs.core:menu/creator/define_cache/place
execute as @s[tag=Glib_Creator_system.cache.remove] at @s run function bs.core:menu/creator/define_cache/remove

#execute as @s[tag=Glib_Creator_system.cache] at @s run function bs.cache:generate_module_ghost
