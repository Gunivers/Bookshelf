...
tellraw @a[tag=bs.menu,scores={bs.menu.page = 0}] [{"text": "    ", "color": "gray"}]
tellraw @a[tag=bs.menu,scores={bs.menu.page = 0}] [{"text": "   "}, {"text": "Documentation", "color": "blue", "clickEvent": {"action": "open_url", "value": "https://glibs.rtfd.io"}, "hoverEvent": {"action": "show_text", "contents": "Click to follow the link"}}, {"text": " ➥", "color": "blue"}]
tellraw @a[tag=bs.menu,scores={bs.menu.page = 0}] [{"text": "    ", "color": "gray"}]
...
tellraw @a[tag=bs.menu] [{"text": "\n"}, {"text": " x ", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add bs.menu.close"}, "hoverEvent": {"action": "show_text", "contents": "Exit menu"}}, {"text": "Glib Menu", "color": "dark_aqua", "underlined": true, "bold": true, "clickEvent": {"action": "run_command", "value": "/tag @s add bs.menu.close"}, "hoverEvent": {"action": "show_text", "contents": "Exit menu"}}]