...
tellraw @a[tag=bs.menu.debug.move.by_motion] [{"text": "\n"}, {"text": " < ", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add bs.menu.debug.move.by_motion.close"}, "hoverEvent": {"action": "show_text", "contents": "Go back"}}, {"text": "bs Menu / Debug / move / by_motion", "color": "dark_aqua", "underlined": true, "bold": true, "clickEvent": {"action": "run_command", "value": "/tag @s add bs.menu.debug.move.by_motion.close"}, "hoverEvent": {"action": "show_text", "contents": "Go back"}}]