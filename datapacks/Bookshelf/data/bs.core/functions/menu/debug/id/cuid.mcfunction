...
tellraw @a[tag=bs.menu.debug.id.cuid] [{"text": "\n"}, {"text": " < ", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add bs.menu.debug.id.cuid.close"}, "hoverEvent": {"action": "show_text", "contents": "Go back"}}, {"text": "bs Menu / Debug / id / cuid", "color": "dark_aqua", "underlined": true, "bold": true, "clickEvent": {"action": "run_command", "value": "/tag @s add bs.menu.debug.id.cuid.close"}, "hoverEvent": {"action": "show_text", "contents": "Go back"}}]