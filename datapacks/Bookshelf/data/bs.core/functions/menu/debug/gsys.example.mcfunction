...
tellraw @a[tag=bs.menu.debug.gsys.example] [{"text": "\n"}, {"text": " < ", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add bs.menu.debug.gsys.example.close"}, "hoverEvent": {"action": "show_text", "contents": "Go back"}}, {"text": "Glib Menu / Debug / gsys.example", "color": "dark_aqua", "underlined": true, "bold": true, "clickEvent": {"action": "run_command", "value": "/tag @s add bs.menu.debug.gsys.example.close"}, "hoverEvent": {"action": "show_text", "contents": "Go back"}}]