...
# Fire Tick
execute store result score menu.rules.fireTick bs.data run gamerule doFireTick
...
# Keep Inventory
execute store result score menu.rules.keepInventory bs.data run gamerule keepInventory
