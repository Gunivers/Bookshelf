...
execute store result score $position.get_distance_ata bs.out as B5-0-0-0-2 run return run function bs.position:get/distance_ata/compute with storage bs:ctx
