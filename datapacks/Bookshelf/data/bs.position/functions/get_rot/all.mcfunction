...
$execute store result score @s bs.rot.h run data get entity 72398515-296d-4e77-bd30-412f6f65d642 Rotation[0] $(scale)
$execute store result score @s bs.rot.v run data get entity 72398515-296d-4e77-bd30-412f6f65d642 Rotation[1] $(scale)
