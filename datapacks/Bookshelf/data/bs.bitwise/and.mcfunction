...
execute if score @s bs.var0 matches ..-1 if score @s bs.var1 matches ..-1 run tag @s add bs.bitwise.and.negative_operands
...
execute if entity @s[tag=bs.bitwise.and.negative_operands] run scoreboard players operation @s bs.var0 = @s bs.res0
execute if entity @s[tag=bs.bitwise.and.negative_operands] run function bs.bitwise:two_complement
execute if entity @s[tag=bs.bitwise.and.negative_operands] run scoreboard players operation @s bs.res0 *= -1 bs.const
