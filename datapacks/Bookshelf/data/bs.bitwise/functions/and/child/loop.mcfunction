...
execute if score @s bs.in.3 matches 1 if score @s bs.in.4 matches 1 run scoreboard players operation @s bs.out.0 += @s bs.in.2
...
execute unless score @s bs.in.1 matches ..0 run function bs.bitwise:and/child/loop