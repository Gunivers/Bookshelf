...
execute if score @s bs.var0 matches ..-1 run tag @s add bs.bitwise.or.negative_operors
execute if score @s bs.var1 matches ..-1 run tag @s add bs.bitwise.or.negative_operors
...
execute if entity @s[tag=bs.bitwise.or.negative_operors] run scoreboard players operation @s bs.var0 = @s bs.res0
execute if entity @s[tag=bs.bitwise.or.negative_operors] run function bs.bitwise:two_complement
execute if entity @s[tag=bs.bitwise.or.negative_operors] run scoreboard players operation @s bs.res0 *= -1 bs.const
