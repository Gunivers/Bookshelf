...
execute as @e[type=minecraft:armor_stand,tag=packtest.1] run function #bs.link:remove_link
assert not entity @e[type=minecraft:armor_stand,tag=packtest.2,predicate=bs.link:has_link]

# from child
execute as @e[type=minecraft:armor_stand,tag=packtest.2] at @e[type=minecraft:armor_stand,tag=packtest.1] run function #bs.link:create_link_ata
execute as @e[type=minecraft:armor_stand,tag=packtest.2] run function #bs.link:remove_link
assert not entity @e[type=minecraft:armor_stand,tag=packtest.2,predicate=bs.link:has_link]
