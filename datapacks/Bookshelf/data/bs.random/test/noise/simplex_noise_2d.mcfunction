...
assert score $random.simplex_noise_2d bs.out matches -444
...
function #bs.random:simplex_noise_2d
assert score $random.simplex_noise_2d bs.out matches 151
...
function #bs.random:simplex_noise_2d
assert score $random.simplex_noise_2d bs.out matches 513
...
function #bs.random:simplex_noise_2d
assert score $random.simplex_noise_2d bs.out matches -933
