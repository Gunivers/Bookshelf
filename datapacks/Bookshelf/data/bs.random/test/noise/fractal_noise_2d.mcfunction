...
assert score $random.fractal_noise_2d bs.out matches -309
...
function #bs.random:fractal_noise_2d
assert score $random.fractal_noise_2d bs.out matches 442
...
function #bs.random:fractal_noise_2d
assert score $random.fractal_noise_2d bs.out matches 466
...
function #bs.random:fractal_noise_2d
assert score $random.fractal_noise_2d bs.out matches -676
