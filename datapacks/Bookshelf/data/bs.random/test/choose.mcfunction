...
execute store result score #result bs.data run function #bs.random:choose
...
execute store result score #packtest.0 bs.data run function #bs.random:choose
execute store result score #packtest.1 bs.data run function #bs.random:choose
execute store result score #packtest.2 bs.data run function #bs.random:choose
execute store result score #packtest.3 bs.data run function #bs.random:choose
execute store result score #packtest.4 bs.data run function #bs.random:choose
