...
execute store result score #i bs.ctx run scoreboard players operation #s bs.ctx = $random.simplex_noise.x bs.in
scoreboard players operation #j bs.ctx = $random.simplex_noise.y bs.in
execute store result storage bs:ctx y int 1 run scoreboard players operation #s bs.ctx += $random.simplex_noise.y bs.in
...
execute store result score #t bs.ctx run scoreboard players operation #u bs.ctx += $random.simplex_noise.x bs.in
...
return run scoreboard players operation $random.simplex_noise bs.out /= 14 bs.const
