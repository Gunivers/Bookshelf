...
execute if score #tmp bs.random matches 0 run function bs.random:noise/white_noise/exec with storage bs:random tmp
execute if score #tmp bs.random matches 0 if score #postpone bs.random matches 1.. run schedule function bs.random:noise/white_noise/xloop 1t
...
execute if score #x bs.random = #height bs.random unless score #tmp bs.random matches 0 run function bs.random:noise/white_noise/exec with storage bs:random tmp
execute if score #x bs.random < #height bs.random run function bs.random:noise/white_noise/xloop