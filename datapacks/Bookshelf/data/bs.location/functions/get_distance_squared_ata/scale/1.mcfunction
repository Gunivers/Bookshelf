...
execute store result score #X bs.data run data get entity @s Pos[0] 10
execute store result score #Y bs.data run data get entity @s Pos[1] 10
execute store result score #Z bs.data run data get entity @s Pos[2] 10

summon marker ~ ~ ~ {Tags:["bs","bs.location.GetDistance"]}

execute store result score #DX bs.data run data get entity @e[type=marker,tag=bs.location.GetDistance,limit=1] Pos[0] 10
execute store result score #DY bs.data run data get entity @e[type=marker,tag=bs.location.GetDistance,limit=1] Pos[1] 10
execute store result score #DZ bs.data run data get entity @e[type=marker,tag=bs.location.GetDistance,limit=1] Pos[2] 10
