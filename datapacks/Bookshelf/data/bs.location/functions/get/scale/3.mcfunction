...
# Original path : bs.location:get/scale/3
...
execute store result score @s bs.loc.y run data get entity @e[type=marker,tag=bs.location.get,limit=1,sort=nearest] Pos[1] 1000
execute store result score @s bs.loc.z run data get entity @e[type=marker,tag=bs.location.get,limit=1,sort=nearest] Pos[2] 1000
