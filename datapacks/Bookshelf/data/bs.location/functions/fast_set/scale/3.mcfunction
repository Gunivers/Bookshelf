...
execute if score @s bs.loc.x matches 1.. run function bs.location:fast_set/scale/3/x_p
execute if score @s bs.loc.x matches ..-1 run function bs.location:fast_set/scale/3/x_n
execute if score @s bs.loc.y matches 1.. run function bs.location:fast_set/scale/3/y_p
execute if score @s bs.loc.y matches ..-1 run function bs.location:fast_set/scale/3/y_n
execute if score @s bs.loc.z matches 1.. run function bs.location:fast_set/scale/3/z_p
execute if score @s bs.loc.z matches ..-1 run function bs.location:fast_set/scale/3/z_n
