...
execute if score #view.looked_entity bs.data matches 4.. if predicate bs.view:looked_entity/b2 run tag @e[tag=bs.view.bi,tag=!bs.view.b2] remove bs.view.bi
execute if score #view.looked_entity bs.data matches 8.. if predicate bs.view:looked_entity/b3 run tag @e[tag=bs.view.bi,tag=!bs.view.b3] remove bs.view.bi
execute if score #view.looked_entity bs.data matches 16.. if predicate bs.view:looked_entity/b4 run tag @e[tag=bs.view.bi,tag=!bs.view.b4] remove bs.view.bi
