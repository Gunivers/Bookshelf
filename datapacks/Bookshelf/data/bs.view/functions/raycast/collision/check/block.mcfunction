...
execute store result storage bs:_ id short 1 run scoreboard players get #view.raycast.block.id bs.data
function bs.view:raycast/hitbox/block/dispatch with storage bs:_
