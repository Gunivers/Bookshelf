...
execute store result storage bs:data _ short 1 run scoreboard players get #view.raycast.entity.id bs.data
function bs.view:raycast/hitbox/entity/dispatch with storage bs:data

execute if score #view.raycast.entity.id bs.data matches 1.. unless data storage bs:data _[] run function bs.view:raycast/collision/check/size
execute if score #view.raycast.entity.id bs.data matches 1.. if data storage bs:data _[] run function bs.view:raycast/collision/check/shape
