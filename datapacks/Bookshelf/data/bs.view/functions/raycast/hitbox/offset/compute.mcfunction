...
execute store result score #view.raycast.hitbox.offset_kx bs.data run data get storage bs:data _[0]
execute store result score #view.raycast.hitbox.offset_kz bs.data run data get storage bs:data _[1]
...
data modify storage bs:data view.raycast.offsets[].k set from storage bs:data _
