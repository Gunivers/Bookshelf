...
execute store result storage bs:_ range double 0.002 run scoreboard players get $math.sin bs.out
execute facing entity @s eyes positioned ^ ^ ^1 rotated as @s positioned ^ ^ ^1 run tp B5-0-0-0-1 ~ ~ ~
execute store result score #view.in_view_ata bs.data run function bs.view:in_view_ata/in_range with storage bs:_
