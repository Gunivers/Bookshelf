...
scoreboard players operation @s ActualBlockID = @s bs.blockId
#Si le block est a remplacer on le remplace 
execute if score @s ActualBlockID = @s bs.original.id run scoreboard players operation @s bs.blockId = @s bs.replace.id
#Et on set le block 
