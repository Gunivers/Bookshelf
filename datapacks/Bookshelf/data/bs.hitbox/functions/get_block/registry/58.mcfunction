...
execute if score #hitbox.get_block.offset_x bs.data matches 125000.. run scoreboard players set #hitbox.get_block.offset_x bs.data 125000
execute if score #hitbox.get_block.offset_x bs.data matches ..-125000 run scoreboard players set #hitbox.get_block.offset_x bs.data -125000
execute if score #hitbox.get_block.offset_z bs.data matches 125000.. run scoreboard players set #hitbox.get_block.offset_z bs.data 125000
execute if score #hitbox.get_block.offset_z bs.data matches ..-125000 run scoreboard players set #hitbox.get_block.offset_z bs.data -125000
