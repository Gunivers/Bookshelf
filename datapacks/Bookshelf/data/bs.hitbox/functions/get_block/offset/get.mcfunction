tp B5-0-0-0-1 ~ ~ ~
execute store result score $hitbox.offset.x bs.out store result storage bs:ctx x int 1 run data get entity B5-0-0-0-1 Pos[0]
execute store result score $hitbox.offset.z bs.out store result storage bs:ctx z int 1 run data get entity B5-0-0-0-1 Pos[2]
