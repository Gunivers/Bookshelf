...
execute store result score $hitbox.offset_x bs.out run data get storage bs:ctx _.x
execute store result score $hitbox.offset_z bs.out run data get storage bs:ctx _.z
