...
execute if score #success bs.data matches 0 run scoreboard players set $hitbox.height bs.out 1870
execute if score #success bs.data matches 1 run scoreboard players set $hitbox.width bs.out 450
execute if score #success bs.data matches 1 run scoreboard players set $hitbox.height bs.out 935
