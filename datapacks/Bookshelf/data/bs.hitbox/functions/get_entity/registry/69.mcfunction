...
execute at @s positioned ~ ~.5 ~ store result score #hitbox.get_entity.is_sleeping bs.data unless entity @s[dx=0]
...
execute if score #hitbox.get_entity.is_sleeping bs.data matches 1 run scoreboard players set $hitbox.width bs.out 200000
execute if score #hitbox.get_entity.is_sleeping bs.data matches 1 run scoreboard players set $hitbox.height bs.out 200000
