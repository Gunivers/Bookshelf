...
execute if score #success bs.data matches 0 run scoreboard players set @s bs.height 1700
execute if score #success bs.data matches 1 run scoreboard players set @s bs.width 450
execute if score #success bs.data matches 1 run scoreboard players set @s bs.height 850
