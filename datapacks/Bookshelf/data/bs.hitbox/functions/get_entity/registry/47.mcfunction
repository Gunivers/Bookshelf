...
execute if score #success bs.data matches 0 run scoreboard players set @s bs.height 1300
execute if score #success bs.data matches 1 run scoreboard players set @s bs.width 450
execute if score #success bs.data matches 1 run scoreboard players set @s bs.height 650
