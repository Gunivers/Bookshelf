...
data modify storage bs:out hitbox.scale set value 1.0
#execute store result storage bs:out hitbox.scale double .000001 run attribute @s minecraft:generic.scale get 1000000
