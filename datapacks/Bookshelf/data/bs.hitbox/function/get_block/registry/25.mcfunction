...
execute if block ~ ~ ~ #bs.hitbox:shape/coral_wall_fan[facing=north] run data modify storage bs:out hitbox.shape set value [[0, 4, 5, 16, 12, 16]]
execute if block ~ ~ ~ #bs.hitbox:shape/coral_wall_fan[facing=south] run data modify storage bs:out hitbox.shape set value [[0, 4, 0, 16, 12, 11]]
