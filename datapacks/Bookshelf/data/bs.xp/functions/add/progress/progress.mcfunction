execute unless score #xp.use_macro bs.data matches 1 store success score #xp.storage_changed bs.data run data modify storage bs:data xp.add_progress.points set from storage bs:in xp.add_progress.points
