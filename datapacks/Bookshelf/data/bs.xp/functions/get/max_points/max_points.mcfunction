...
execute store result score #xp.get_max_points.levels bs.data store result score #xp.get_max_points bs.data run xp query @s levels
...
return run scoreboard players get #xp.get_max_points bs.data
