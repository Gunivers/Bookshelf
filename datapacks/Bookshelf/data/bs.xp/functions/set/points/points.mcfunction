...
execute unless score #xp.use_macro bs.data matches 1 unless score #xp.set_points.check bs.data = $xp.set_points.points bs.in store result storage bs:in xp.set_points.points int 1 run scoreboard players operation #xp.set_points.check bs.data = $xp.set_points.points bs.in
