execute unless score #xp.use_macro bs.data matches 1 store success score #xp.storage_changed bs.data run data modify storage bs:data xp.set_total_points.points set from storage bs:in xp.set_total_points.points
