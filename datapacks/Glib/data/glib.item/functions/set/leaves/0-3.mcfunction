...
execute if score @s glib.itemId matches 2 run summon item ~ ~ ~ {PickupDelay:999999,Tags:["glib.new"],"Item":{"id":"minecraft:acacia_door","Count":1b}}
execute if score @s glib.itemId matches 3 run summon item ~ ~ ~ {PickupDelay:999999,Tags:["glib.new"],"Item":{"id":"minecraft:acacia_fence","Count":1b}}
