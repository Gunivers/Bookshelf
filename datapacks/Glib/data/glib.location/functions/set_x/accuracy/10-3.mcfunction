...
# Original path: glib.location:set_x/accuracy/10-3
# Parallelizable: true
...
execute if entity @s[type=minecraft:player] as @e[tag=glib.new,limit=1] run function glib.location:set_x/accuracy/10-3/player
