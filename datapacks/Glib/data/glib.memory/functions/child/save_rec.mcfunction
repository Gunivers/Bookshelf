...
# CHILD OF: glib.memory:save_in_memory
...
execute if score @s glib.var0 matches 1 if data entity @s ArmorItems[0].tag.Memory[0] run function glib_child:default/core/memory/save_rec
