...
execute as @s[tag=glib.menu.Debug] at @s run function glib.core:menu/debug/main
execute as @s[tag=glib.menu.Creator] at @s run function glib.core:menu/creator/main
execute as @s[tag=glib.menu.Rules] at @s run function glib.core:menu/gamerule/rules
execute as @s[tag=glib.menu.Informations] at @s run function glib.core:menu/informations
