...
tellraw @a[tag=glib.menu.debug.health,scores={glib.menu.page = 0},tag=!glib.debug.health.safe_kill] ["", {"text": "   safe_kill: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.health.safe_kill"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.health.safe_kill"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}]
tellraw @a[tag=glib.menu.debug.health,scores={glib.menu.page = 0},tag=glib.debug.health.safe_kill] ["", {"text": "   safe_kill: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.health.safe_kill"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.health.safe_kill"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}]
tellraw @a[tag=glib.menu.debug.health,scores={glib.menu.page = 0},tag=!glib.debug.health.time_to_live] ["", {"text": "   time_to_live: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.health.time_to_live"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.health.time_to_live"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}]
tellraw @a[tag=glib.menu.debug.health,scores={glib.menu.page = 0},tag=glib.debug.health.time_to_live] ["", {"text": "   time_to_live: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.health.time_to_live"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.health.time_to_live"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}]
