...
tellraw @a[tag=glib.menu.debug.schedule,scores={glib.menu.page = 0},tag=!glib.debug.schedule.cancel_schedule_command] ["", {"text": "   cancel_schedule_command: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.schedule.cancel_schedule_command"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.schedule.cancel_schedule_command"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}]
tellraw @a[tag=glib.menu.debug.schedule,scores={glib.menu.page = 0},tag=glib.debug.schedule.cancel_schedule_command] ["", {"text": "   cancel_schedule_command: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.schedule.cancel_schedule_command"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.schedule.cancel_schedule_command"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}]
tellraw @a[tag=glib.menu.debug.schedule,scores={glib.menu.page = 0},tag=!glib.debug.schedule.clear_queue] ["", {"text": "   clear_queue: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.schedule.clear_queue"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.schedule.clear_queue"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}]
tellraw @a[tag=glib.menu.debug.schedule,scores={glib.menu.page = 0},tag=glib.debug.schedule.clear_queue] ["", {"text": "   clear_queue: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.schedule.clear_queue"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.schedule.clear_queue"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}]
tellraw @a[tag=glib.menu.debug.schedule,scores={glib.menu.page = 0},tag=!glib.debug.schedule.schedule_command] ["", {"text": "   schedule_command: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.schedule.schedule_command"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.schedule.schedule_command"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}]
tellraw @a[tag=glib.menu.debug.schedule,scores={glib.menu.page = 0},tag=glib.debug.schedule.schedule_command] ["", {"text": "   schedule_command: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.schedule.schedule_command"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.schedule.schedule_command"}, "hoverEvent": {"action": "show_text", "contents": "Click to change the value"}}]
