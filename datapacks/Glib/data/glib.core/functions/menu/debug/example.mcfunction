...
tellraw @a[tag=glib.menu.debug.example,scores={glib.menu.page = 0},tag=!glib.debug.example.biome_displayer] ["", {"text": "   biome_displayer: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.example.biome_displayer"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.example.biome_displayer"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}]
tellraw @a[tag=glib.menu.debug.example,scores={glib.menu.page = 0},tag=glib.debug.example.biome_displayer] ["", {"text": "   biome_displayer: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.example.biome_displayer"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.example.biome_displayer"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}]
tellraw @a[tag=glib.menu.debug.example,scores={glib.menu.page = 0},tag=!glib.debug.example.drop_to_place] ["", {"text": "   drop_to_place: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.example.drop_to_place"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.example.drop_to_place"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}]
tellraw @a[tag=glib.menu.debug.example,scores={glib.menu.page = 0},tag=glib.debug.example.drop_to_place] ["", {"text": "   drop_to_place: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.example.drop_to_place"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.example.drop_to_place"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}]
tellraw @a[tag=glib.menu.debug.example,scores={glib.menu.page = 0},tag=!glib.debug.example.lgdir] ["", {"text": "   lgdir: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.example.lgdir"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.example.lgdir"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}]
tellraw @a[tag=glib.menu.debug.example,scores={glib.menu.page = 0},tag=glib.debug.example.lgdir] ["", {"text": "   lgdir: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.example.lgdir"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.example.lgdir"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}]
tellraw @a[tag=glib.menu.debug.example,scores={glib.menu.page = 0},tag=!glib.debug.example.walk_trail] ["", {"text": "   walk_trail: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.example.walk_trail"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.example.walk_trail"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}]
tellraw @a[tag=glib.menu.debug.example,scores={glib.menu.page = 0},tag=glib.debug.example.walk_trail] ["", {"text": "   walk_trail: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.example.walk_trail"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.example.walk_trail"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}]
