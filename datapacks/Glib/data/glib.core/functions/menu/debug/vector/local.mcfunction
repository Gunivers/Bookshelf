...
tellraw @a[tag=glib.menu.debug.vector.local,scores={glib.menu.page = 0},tag=!glib.debug.vector.local.fast_normalize] ["", {"text": "   fast_normalize: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.vector.local.fast_normalize"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.vector.local.fast_normalize"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}]
tellraw @a[tag=glib.menu.debug.vector.local,scores={glib.menu.page = 0},tag=glib.debug.vector.local.fast_normalize] ["", {"text": "   fast_normalize: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.vector.local.fast_normalize"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.vector.local.fast_normalize"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}]
tellraw @a[tag=glib.menu.debug.vector.local,scores={glib.menu.page = 0},tag=!glib.debug.vector.local.get_from_classic_vector] ["", {"text": "   get_from_classic_vector: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.vector.local.get_from_classic_vector"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.vector.local.get_from_classic_vector"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}]
tellraw @a[tag=glib.menu.debug.vector.local,scores={glib.menu.page = 0},tag=glib.debug.vector.local.get_from_classic_vector] ["", {"text": "   get_from_classic_vector: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.vector.local.get_from_classic_vector"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.vector.local.get_from_classic_vector"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}]
