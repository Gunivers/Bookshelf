...
tellraw @a[tag=glib.menu.debug.math.special,scores={glib.menu.page = 0},tag=!glib.debug.math.special.get_next_pow2] ["", {"text": "   get_next_pow2: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.math.special.get_next_pow2"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.math.special.get_next_pow2"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}]
tellraw @a[tag=glib.menu.debug.math.special,scores={glib.menu.page = 0},tag=glib.debug.math.special.get_next_pow2] ["", {"text": "   get_next_pow2: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.math.special.get_next_pow2"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.math.special.get_next_pow2"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}]
tellraw @a[tag=glib.menu.debug.math.special,scores={glib.menu.page = 0},tag=!glib.debug.math.special.random] ["", {"text": "   random: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.math.special.random"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}, {"text": "✗", "color": "red", "clickEvent": {"action": "run_command", "value": "/tag @s add glib.debug.math.special.random"}, "hoverEvent": {"action": "show_text", "contents": "Click to add the tag"}}]
tellraw @a[tag=glib.menu.debug.math.special,scores={glib.menu.page = 0},tag=glib.debug.math.special.random] ["", {"text": "   random: ", "color": "gray", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.math.special.random"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}, {"text": "✔", "color": "green", "clickEvent": {"action": "run_command", "value": "/tag @s remove glib.debug.math.special.random"}, "hoverEvent": {"action": "show_text", "contents": "Click to remove the tag"}}]
