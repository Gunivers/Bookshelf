...
execute unless data storage bs:const log.messages run data modify storage bs:const log.messages set value [ \
  { \
    format: { \
...
execute unless data storage bs:const log.messages[{namespaces: ["bs"]}].format run data modify storage bs:const log.messages[{namespaces: ["bs"]}] merge value { \
    format: { \
