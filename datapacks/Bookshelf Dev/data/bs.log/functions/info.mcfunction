...
data modify storage bs:data log.ctx set from storage bs:const log.messages.default.info
$data modify storage bs:data log.ctx set from storage bs:const log.messages."$(namespace)".info
