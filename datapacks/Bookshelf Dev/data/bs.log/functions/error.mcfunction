...
data modify storage bs:ctx _ set from storage bs:const log.messages.default.error
$data modify storage bs:ctx _ set from storage bs:const log.messages."$(namespace)".error
