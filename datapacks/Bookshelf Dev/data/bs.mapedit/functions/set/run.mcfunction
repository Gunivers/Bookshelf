...
execute if score @s BrushID matches 1 run function bs.mapedit:brush/set
execute if score @s BrushID matches 2 run function bs.mapedit:brush/replace
execute if score @s BrushID matches 3 run function bs.mapedit:brush/sphere
execute if score @s BrushID matches 4 run function bs.mapedit:brush/esphere
