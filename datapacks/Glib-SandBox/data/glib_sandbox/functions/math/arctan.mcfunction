...
execute as @e[tag=glib.sandbox.plot,tag=!glib.sandbox.plot.drawed] run function glib_wip:math/trig/arctan
...
execute as @e[tag=glib.sandbox.plot,tag=!glib.sandbox.plot.drawed] run scoreboard players operation @s glib.plot.y *= 5 glib.const
...
summon minecraft:armor_stand 0.5 97 0.5 {Tags:["glib","glib.sandbox.plot.legend.new"],CustomName:'{"text":"-45°"}',CustomNameVisible:1b,NoGravity:1,Invisible:1,Marker:1}
...
summon minecraft:armor_stand 0.5 97 0.5 {Tags:["glib","glib.sandbox.plot.legend.new"],CustomName:'{"text":"arctan(x)"}',CustomNameVisible:1b,NoGravity:1,Invisible:1,Marker:1}
