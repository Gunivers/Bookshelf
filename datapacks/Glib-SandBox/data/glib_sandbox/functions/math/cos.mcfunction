...
execute as @e[tag=glib.sandbox.plot,tag=!glib.sandbox.plot.drawed] run scoreboard players operation @s glib.var0 *= 180 glib.const
...
execute as @e[tag=glib.sandbox.plot,tag=!glib.sandbox.plot.drawed] run function glib.math:trig/cos
#execute as @e[tag=glib.sandbox.plot,tag=!glib.sandbox.plot.drawed] run tellraw @a ["",{"text":"Debug | glib_sandbox:math/plot/cos","color":"green"},{"text":"\n \u0020 Input : "},{"score":{"name":"@s","objective":"glib.var0"}},{"text":" Output : "},{"score":{"name":"@s","objective":"glib.res0"}}]
...
summon minecraft:armor_stand 0.5 97 0.5 {Tags:["glib","glib.sandbox.plot.legend.new"],CustomName:'{"text":"-180°"}',CustomNameVisible:1b,NoGravity:1,Invisible:1,Marker:1}
...
summon minecraft:armor_stand 0.5 97 0.5 {Tags:["glib","glib.sandbox.plot.legend.new"],CustomName:'{"text":"cos(x)"}',CustomNameVisible:1b,NoGravity:1,Invisible:1,Marker:1}
