...
# PATH: Entity/Id/UpdateCUID-Check
...
execute @e[tag=StackedCUID] ~ ~ ~ function Gunivers-Lib:Entity/Id/UpdateCUID-Unstack
...
execute @e[tag=AnotherLoop,c=1] ~ ~ ~ function Gunivers-Lib:Entity/Id/UpdateCUID-Check
