...
# - Phi (score dummy)
# - Theta (score dummy)
# - Entity/Orientation/Advanced/Get-Slave (function)
# - Constants (Import)
...
execute @e[type=armor_stand,tag=GetOrientation,c=1] ~ ~ ~ function Gunivers-Lib:Entity/Orientation/Advanced/Get-Slave
